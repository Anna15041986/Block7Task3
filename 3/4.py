...
# - вариант вывода в строку
print(f"Отчет по списку товаров: \n{report}")

# - вариант вывода в стоблец (как в примере)
print('\n')
print(f"названия: {product_names}")
print(f"цены: {product_prices}")
print(f"количества: {product_counts}")
print(f"ед: {product_measures}")
